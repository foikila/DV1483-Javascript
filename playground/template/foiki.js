...
window.Foiki = (function(window, document, undefined ) {
    ...
    */
    Foiki.reflection = function (obj) {
        ...
        if (obj instanceof Boolean)
            console.log("is instance of: Boolean");
        if (obj instanceof Date)
            console.log("is instance of: Date");
        if (obj instanceof Function)
            console.log("is instance of: Function");
        if (obj instanceof Number)
            console.log("is instance of: Number");
        if (obj instanceof RegExp)
            console.log("is instance of: RegExp");
    ...
    * @returns string
    */
    Foiki.dumpAsString = function (obj) {
        var s = '\n';
        for (var prop in obj) {
            if (obj.hasOwnProperty(prop)) {
                s += prop + ' : ' + obj[prop] + '\n';
    ...
    */
    Foiki.deleteLESSFromLocalStorage = function (which) {
